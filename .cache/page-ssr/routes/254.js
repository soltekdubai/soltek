...
*/
var aa=__webpack_require__(6679),ca=__webpack_require__(9982);function p(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var da=new Set,ea={};function fa(a,b){ha(a,b);ha(a+"Capture",b)}
...
var index_js_ = __webpack_require__(6679);
...
var react_spring_shared_modern_useIsomorphicLayoutEffect = isSSR() ? index_js_.useEffect : index_js_.useLayoutEffect;
...
var react_spring_shared_modern_useOnce = (effect) => (0,index_js_.useEffect)(effect, emptyDeps);
var emptyDeps = [];
...
var withAnimated = (Component, host) => {
  ...
  return (0,index_js_.forwardRef)((givenProps, givenRef) => {
    ...
    return /* @__PURE__ */ index_js_.createElement(Component, { ...usedProps, ref });
  });
};
...
var SpringContext = ({
  ...
  const { Provider } = ctx;
  return /* @__PURE__ */ index_js_.createElement(Provider, { value: props }, children);
};
...
var ParentContext = index_js_.createContext(null);
...
var ParallaxLayer = index_js_.memo(
  index_js_.forwardRef(
...
var Parallax = index_js_.memo(
  index_js_.forwardRef((props, ref) => {
    ...
    return /* @__PURE__ */ index_js_.createElement(
      ...
      ready && /* @__PURE__ */ index_js_.createElement(index_js_.Fragment, null, /* @__PURE__ */ index_js_.createElement(
        animated.div,
        {
          ref: contentRef,
          style: {
        ...
        /* @__PURE__ */ index_js_.createElement(ParentContext.Provider, { value: state }, mapChildrenRecursive(
          children,
